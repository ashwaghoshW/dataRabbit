...
app = DjangoDash('AreaChart', external_stylesheets=external_stylesheets, add_bootstrap_links=True)
data=[
                go.Scatter(x=df2['Month'], y=df2['Sales'],name='Sales',fill='tozeroy'),
                go.Scatter(x=df2['Month'], y=df2['Target'],name='Target',fill='tonexty')
 ]
