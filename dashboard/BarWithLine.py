...
app = DjangoDash('BarWithLine', external_stylesheets=external_stylesheets, add_bootstrap_links=True)


data=[
                go.Bar(name='Sales', x=df2['Month'], y=df2['Sales'], marker_color='lightsalmon'),
