...
app = DjangoDash('BarInsideBar', external_stylesheets=external_stylesheets, add_bootstrap_links=True)

data=[
go.Bar(name='Target', x=df2['Month'], y=df2['Target'],width=0.8, marker_color='indianred'),
go.Bar(name='Sales Lead', x=df2_Lead['Month'], y=df2_Lead['Sales'],width=0.5,  marker_color=df2_Lead['Colour']),
go.Bar(name='Sales Lag', x=df2_Lag['Month'], y=df2_Lag['Sales'],width=0.5,  marker_color=df2_Lag['Colour']),
]

layout=go.Layout(barmode='overlay', hovermode="closest",
